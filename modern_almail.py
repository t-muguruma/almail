...
class ModernALMail:
    ...
    DOWNLOAD_BASE_URL = "https://github.com/sumeragi-sakura/Petal/raw/main/"
        ...
        def _check():
            try:
                ...
                if remote_version > self.APP_VERSION:
                    ...
                    messagebox.showinfo("アップデート", f"Petal は最新の状態です。\n現在のバージョン: {self.APP_VERSION}")
            except Exception as e:
                messagebox.showerror("エラー", f"アップデートの確認に失敗しました:\n{e}")
